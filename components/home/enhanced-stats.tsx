  ...
  return (
    <div className="mt-16 space-y-12">
      ...
      <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-16">
        <div className="text-center">
          <div className="font-display text-3xl text-warm-text">
        ...
        <div className="text-center">
          ...
          <div className="mt-0.5 text-xs text-warm-muted">Reviews this month</div>
        </div>
        {stats.wouldRentAgainPct !== null && (
          <div className="text-center">
            ...
            <div className="mt-0.5 text-xs text-warm-muted">Would rent again</div>
          </div>
        )}
      </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {stats.topCities.map((city, index) => (
              <Link
                ...
                className="group flex items-center gap-2 rounded-lg border border-warm-border bg-warm-card px-4 py-2 text-sm transition-colors hover:bg-warm-secondary"
              >
                <MapPin className="h-4 w-4 text-warm-muted" />
                ...
                <ChevronRight className="h-4 w-4 text-warm-muted opacity-0 transition-opacity group-hover:opacity-100" />
              </Link>
            ))}
          </div>
        </div>
