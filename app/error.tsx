  ...
  return (
    <div className="bg-warm-bg flex min-h-screen items-center justify-center px-6">
      <div className="text-center">
        <h1 className="font-display text-warm-text mb-4 text-6xl font-bold">500</h1>
        <h2 className="font-display text-warm-text mb-2 text-2xl">Something went wrong</h2>
        ...
        <div className="flex justify-center gap-4">
          <Button onClick={reset} className="bg-warm-text text-warm-card hover:bg-warm-text/90">
