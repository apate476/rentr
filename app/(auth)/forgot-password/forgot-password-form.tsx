  ...
  return (
    <div className="rounded-2xl border border-warm-border bg-warm-card p-8 shadow-lg">
      <div className="mb-6">
        ...
        <h1 className="font-display text-2xl font-bold text-warm-text">Reset Password</h1>
      ...
      {state.success ? (
        <div className="space-y-4">
          ...
          <Button asChild className="w-full bg-warm-text text-warm-card hover:bg-warm-text/90">
